...
@endif
<form name="form" action="{{route('asignaturas.store')}}" method="POST" enctype="multipart/form-data" class="mt-3">
@csrf
<div class="row">
    <div class="col">
    ...
    <div class="col">
        <input type="number" name="horas" placeholder="Horas" class="form-control" required>
    </div>   
</div>
<div class="row mt-3">
    <div class="col">
        <button type="submit" class="btn btn-success"><i class="fa fa-plus"></i> Crear Asignatura</button>
